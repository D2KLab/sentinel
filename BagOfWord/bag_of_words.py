...
train_file = 'data/train_v' 
test_file = 'data/test_c'
...
model = LR()
model.fit( train_x, train["positive|negative|neutral|objective"] )
...
output = pd.DataFrame( data = { "Message": test["SID"], "sentiment": p } )
